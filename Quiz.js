...
const questions = [
  {
    ...
    options: ['Scarcely available', 'Plentiful', 'Complicated', 'Transparent'],
  ...
  {
    question: 'Click the best synonym for reject:',
    options: ['check on', 'turn around', 'cut down', 'turn down'],
    correctAnswer: 'turn down',
  },
  {
    question: 'Click the best synonym for value:',
    options: ['importance', 'exchange', 'wave', 'opinion'],
    correctAnswer: 'importance',
  },
  {
    question: 'Click the best synonym for mutual:',
